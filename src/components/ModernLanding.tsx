...
import StyleDnaShowcase from './StyleDnaShowcase';
      ...
      <header className="sticky top-0 z-40 border-b border-[#18201d]/10 bg-[#f7f7f4]/90 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
          ...
          <nav className="hidden items-center gap-1 md:flex" aria-label="Primary navigation">
            {[['How it works', 'how-it-works'], ['Style DNA', 'style-dna'], ['Editor', 'editor'], ['Pricing', 'pricing']].map(([label, id]) => <button key={id} onClick={() => scrollTo(id)} className="rounded-lg px-3 py-2 text-sm font-semibold text-[#53605a] transition hover:bg-white hover:text-[#18201d]">{label}</button>)}
          </nav>
